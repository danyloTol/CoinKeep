...
const WidgetSExpense = ({thisMonthValue, lastMonthValue}: WidgetProps) => {
    ...
    const changePercent = Math.round((lastMonthValue - thisMonthValue) / thisMonthValue * 100);
